...
const SYSTEM = `You are Cerebro — a sharp, warm CAT prep coach. You combine the wisdom of a career counsellor, sports psychologist, and CAT expert. You work on both exam skills and mental game naturally. Be direct, conversational, under 120 words unless solving. No bullet points in conversation.`;

export default function Coach({ user }) {
  const [messages, setMessages] = useState([
    { role: 'assistant', content: `Hey. I'm your Cerebro coach. Ask me anything — exam strategy, a concept you're stuck on, how to improve a section, or just how you're feeling about the prep. What's on your mind?` }
  ]);
